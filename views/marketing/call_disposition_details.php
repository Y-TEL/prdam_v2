                                                                                ...
                                                                                <form id="commentForm" class="form-horizontal" name ="edit_dep_updates" action="" method="post" enctype="multipart/form-data"> 
                                                                                    <div class="form-body" >
                                                                                            ...
                                                                                            <div class="row">
                                                                                                    <div class="col-md-6">
                                                                                                            <div class="form-group">
                                                                                                                    ...
                                                                                                                    <div class="col-md-6">
                                                                                                                        <label class="control-label-left"><?php echo $details['activation_call_type']; ?></label> 
                                                                                                                    </div>
                                                                                                            </div>
                                                                                                    </div>
                                                                                                    <!--/span-->
                                                                                            ...
                                                                                            <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-md-6">
                                                                                                            <div class="form-group">
                                                                                                                    <label class="control-label col-md-5">Status : <span style="font-size:14px; color:#D90000;" >*</span></label>
                                                                                                                    <div class="col-md-6">
                                                                                                                        <label class="control-label-left"><?php echo $details['activation_dealer_status']; ?></label>
                                                                                                                    </div>
                                                                                                            </div>
                                                                                                    </div>
                                                                                                    <!--/span-->

...
$comp_list = $comparison->viewAllCarrierCopmarison();
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-chambray">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>All Carrier Details
							</div>
							<div class="tools">
                                                            <?php //if(($_SESSION['user_id']=="47")||($_SESSION['user_id']=="49")||($_SESSION['user_id']=="59")){ 
                                                            if (isset($_SESSION['user_permissions']['Carrier_comparison_add']) && ($_SESSION['user_permissions']['Carrier_comparison_add'] == '1')){?> 
								<a href="carrier_comp_add.php" class="btn default" style="text-decoration:none; height: 30px;" >Add New</a>
                                                            <?php } ?>
                                                        </div>
						</div>
						<div class="portlet-body">
							<div class="form-body" >
										...
										<div class="pricing-head">
											...
											<li>
                                                                                                <div class="col-md-12"> 
                                                                                                <label class="control-label col-md-4"><strong>Carrier</strong></label>
                                                                                                <div class="col-md-8"><?php echo $data['carrier_name']; ?></div>
                                                                                                </div>
											</li>
											<li>
												<div class="col-md-12"> 
                                                                                                <label class="control-label col-md-4"><strong>Plan</strong> </label>
                                                                                                <div class="col-md-8"><?php echo $data['plan_name']; ?></div>
                                                                                                </div>
											</li>
											<li>
                                                                                                <div class="col-md-12">
                                                                                                <label class="control-label col-md-4"><strong>Validity</strong> </label>
                                                                                                <div class="col-md-8"><?php echo $data['com_validity']; ?></div>
                                                                                                </div>
											</li>
											
										</ul>
                                                                                <div class="pricing-footer" style=" padding-left: 0; padding-right: 0;">
											<a title="Compare" href="carrier_comparison?id=<?php echo $data['com_id'] ;?>" class="btn yellow-crusta">
											Compare <i class="m-icon-swapright m-icon-white"></i>
											</a>
                                                                                        <?php if (isset($_SESSION['user_permissions']['Carrier_comparison_add']) && ($_SESSION['user_permissions']['Carrier_comparison_add'] == '1')){ ?>
                                                                                    
                                                                                        <a title="Edit" href="carrier_comp_edit?id=<?php echo $data['com_id'] ;?>"  class="btn blue-chambray">Edit </a>
                                                                                        <a title="Delete"  href="carrier_comp_edit?iid=<?php echo $data['com_id'] ;?>" onclick="return confirm('Are you sure you want to delete?')" class="btn blue-chambray">Delete </a>

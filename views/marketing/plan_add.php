...
if (isset($_POST['add'])) {
    ...
    $msg = $plan->addNewPlan($carrier_name,$plan_name);
				  
  if ($msg=1) {
    header('Location: plan_view?id='.$msg);
    }
  }
?>
<!DOCTYPE html>
						  ...
						  <div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Plan Form
										</div>
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
                                                                                 ...
                                                                                 <form id="commentForm" class="form-horizontal" name ="add_new_plan" action="" method="post" enctype="multipart/form-data"> 
											<div class="form-body" >
                                                                                                ...
                                                                                                <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-md-4">
                                                                                                                            <select name="carrier_name" class="select2_category form-control" tabindex="1" data-placeholder="Enter Carrier">

...
if (isset($_POST['add'])) {
    ...
    $msg = $depupdates->addDepUpdates($news,$subject,$department,$news_image,$entered_by,$created_date,$created_time);
    
    if ($msg=1) { 
        header('Location: dep_updates_view?id='.$msg);
	}
}
						  ...
						  <div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add Department Updates
										</div>
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
                                                                                ...
                                                                                <form id="commentForm" class="form-horizontal form-bordered" name ="add_dep_updates" action="" method="post" enctype="multipart/form-data"> 
											<div class="form-body" >

...
if (isset($_POST['add'])) {
    ...
    if(isset($_SESSION['image'])){ $carrier_image = $_SESSION['image']; }else { $carrier_image = "";}
    $desc = filter_input(INPUT_POST, 'desc', FILTER_SANITIZE_STRING);
	
    $msg = $carrier->addNewCarrier($carrier_name,$desc,$carrier_image);
						  ...
						  <div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Carrier Form
										</div>
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
                                                                                        ...
                                                                                        <form id="commentForm" class="form-horizontal" name ="add_new_carrier" action="" method="post" enctype="multipart/form-data"> 
                                                                                         <div class="form-body" >
                                                                                                ...
                                                                                                <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-md-4">
                                                                                                                                <input type="text" name="carrier_name" id="carrier_name" class="form-control" placeholder="Enter Carrier Name">
                                                                                                                        </div>
                                                                                                                </div>
                                                                                                        </div>
                                                                                                        <!--/span-->

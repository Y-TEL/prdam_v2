...
if ($delete=1) {
    header('Location: tv_eblast_view?iiid='.$delete);
}
...
$valid_formats = array("jpg","png","PNG","gif","JPG");
		...
		if(in_array($ext,$valid_formats)) {
			...
			$_SESSION['image']=$image;
                        ...
                        if(isset($_SESSION['image'])){ 
                               $eblast_image = $_SESSION['image'];
                        }else{
                               if($details['tv_eblast_image']!=NULL){  
                                 $eblast_image = $details['tv_eblast_image'];
                                 }else { $eblast_image = "";}
                        }

                        $msg = $Eblast->UpdateEblast($eblast_name,$eblast_image,$eblast_category,$eblast_date,$id);

                        if ($msg=1) {
                            header('Location: tv_eblast_view?iid='.$msg);
                        }
                        //Send to DB
						  ...
						  <div class="tab-pane active" id="tab_2">
								<div class="portlet box blue-madison">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Update E-Blast
										</div>
										...
										<!-- BEGIN FORM-->
											...
											<div class="form-body" >
                                                                                                         ...
                                                                                                         <div class="row fileupload-buttonbar">
                                                                                                            ...
                                                                                                            <script>
                                                                                                                ...
                                                                                                                jQuery("#avatar").fileinput({
                                                                                                                    ...
                                                                                                                    defaultPreviewContent: '<?php if($details['tv_eblast_image']!=NULL){?><img src="<?php echo SITEURL ?>/uploads/tv_eblast/<?php echo $details['tv_eblast_image'];?>" style="width:150px;height:150px;margin:0px 11px 0px 11px; "><?php }else{?><img src="<?php echo SITEURL ?>/assets/resources/images/default_news.png" style="width:150px;height:150px;margin:0px 11px 0px 11px;"><?php } ?>',
														...
														<div class="form-group">
															...
															<div class="col-md-5">
                                                                                                                            <input type="text" name="eblast_name" id="eblast_name" class="form-control" value="<?php echo $details['tv_eblast_name']; ?>">
															</div>
														</div>
													</div>
													<!--/span-->
															...
															<div class="col-md-5">
                                                                                                                            <select name="eblast_category" id="eblast_category" class="form-control" required="">
                                                                                                                                ...
                                                                                                                                <?php  foreach ($drop_down_tv_category as $value) {
                                                                                                                                    if ($value['tv_cat_id'] == $details['tv_eblast_cat_id']) {
                                                                                                                                                $selected = "selected";
                                                                                                                                        } else {
                                                                                                                                                $selected = "";
                                                                                                                                        }
                                                                                                                                    ?>
                                                                                                                                <option value="<?php echo $value['tv_cat_id'];?>" <?php echo $selected; ?>><?php echo $value['tv_cat_name'];?></option>
                                                                                                                                <?php }?>
                                                                                                                            </select>
															</div>
														</div>
													...
													<!--/span-->
														...
														<div class="form-group">
															...
															<div class="col-md-5">
                                                                                                                            <input type="text" name="eblast_date" id="eblast_date" class="form-control" value="<?php echo $details['tv_eblast_date']; ?>" readonly="">
															</div>
														</div>
													</div>
													<!--/span-->

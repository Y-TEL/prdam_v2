    ...
    <!-- BEGIN BODY -->
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <i class="icon-user-follow font-blue-madison bold"></i> Add Dealer
              </div>

                                                                    <div class="actions">
                           
                                        <a class="btn blue btn-sm active" href="dealer_list_view">Dealer List</a>
                        ...
                        <option value="Region XV">Region XV</option>
                        <option value="Region XVI">Region XVI</option>
                        <option value="Region XVII">Region XVII</option>
                        <option value="Region XVIII">Region XVIII</option>
                        </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="row">
                                                                        <div class="col-md-offset-4 col-md-8">
                                                                            <button type="submit" name="add" class="btn blue"><i class="fa fa-save"></i> Save</button>

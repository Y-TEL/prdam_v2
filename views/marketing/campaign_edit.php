...
$iid = $_GET['iid'];
$delete = $campaign->DeleteCampaign($iid);  

if ($delete=1) {
    header('Location: campaign_view?iiid='.$delete);
}
...
$id = $_GET['id'];
$details = $campaign->viewSelectedCampaign($id);                            
...
if (isset($_POST['update'])) {
    ...
    $msg = $campaign->UpdateCampaign($cam_title,$cam_date,$cam_time_sl,$USTime,$id);
            
   if ($msg=1) {
       header('Location: campaign_view?iid='.$msg);
	}
  }
?>
<!DOCTYPE html>
						  ...
						  <div class="tab-pane active" id="tab_2">
								<div class="portlet box blue-madison">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit Campaign
										</div>
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
                                                                                ...
                                                                                <form id="commentForm" class="form-horizontal" name ="edit_campaign" action="" method="post" enctype="multipart/form-data"> 
											<div class="form-body" >
														...
														<div class="form-group">
                                                                                                                    ...
                                                                                                                    <div class="col-md-4">
                                                                                                                        ...
                                                                                                                        <input type="text" class="form-control" id="datepicker" readonly name="cam_date" value="<?php if (isset($_POST['cam_date'])) {echo $_POST['cam_date']; }else{echo date('m-d-Y', strtotime($details['camp_date']));} ?>">
                                                                                                                ...
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-md-4">
                                                                                                                            <div class="input-append bootstrap-timepicker">
                                                                                                                                <input id="timepicker1" type="text" class="input-small" name="cam_time" value="<?php if (isset($_POST['cam_time'])) {echo $_POST['cam_time']; }else{echo $details['camp_time_sl'];} ?>">
												...
												<!--/row-->
													...
													<div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-md-4">
                                                                                                                            <input type="text" name="cam_title" id="cam_title" class="form-control" value="<?php echo $details['camp_title']; ?>" list="mylist">
                                                                                                                            <datalist id="mylist">

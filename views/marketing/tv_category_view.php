...
$category_list = $category->viewCategoryList();
				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							...
							<div class="tools">
								<a href="tv_category_add" class="btn default" style="text-decoration:none; height: 30px;" >Add New</a>
                                                        </div>
						</div>
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									<a title="Edit" href="tv_category_edit?id=<?php echo $data['tv_cat_id'] ;?>"  style="text-decoration:none;">
									<img src="<?php echo SITEURL ?>/assets/admin/pages/img/edit.png" width="20" height="20" /> </a>
								</td>
								<td>
									<a title="Delete"  href="tv_category_edit?iid=<?php echo $data['tv_cat_id'] ;?>" onclick="return confirm('Are you sure you want to delete?')" style="text-decoration:none;">

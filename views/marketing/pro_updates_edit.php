...
if (isset($_POST['update'])) {
	...
	if(isset($_SESSION['image'])){ 
	   $news_image = $_SESSION['image'];
	 }else{
		if($details['news_image']!=NULL){  
		  $news_image = $details['news_image'];
		  }else { $news_image = "";}
	}
    
	$msg = $productList->UpdateNews($news, $subject, $department, $news_image,$id);
            
   if ($msg=1) {
       header('Location: pro_updates_view?iid='.$msg);
    }
  }
											...
											<div class="form-body" >
                                                                                                         ...
                                                                                                         <div class="row fileupload-buttonbar">
                                                                                                            ...
                                                                                                            <script>
                                                                                                                ...
                                                                                                                jQuery("#avatar").fileinput({
                                                                                                                    ...
                                                                                                                    defaultPreviewContent: '<?php if($details['news_image']!=NULL){?><img src="<?php echo SITEURL ?>/uploads/pro_updates/<?php echo $details['news_image'];?>" style="width:150px;height:150px;margin:0px 11px 0px 11px; "><?php }else{?><img src="<?php echo SITEURL ?>/assets/resources/images/default_news.png" style="width:150px;height:150px;margin:0px 11px 0px 11px;"><?php } ?>',
															...
															<div class="col-md-5">
                                                                                                                            <select name="department" id="department" class="form-control" required="">
                                                                                                                                ...
                                                                                                                                <?php  foreach ($drop_down_user_dept as $value) {
                                                                                                                                    if ($value['dep_name'] == $details['news_dept']) {
                                                                                                                                                $selected = "selected";
                                                                                                                                        } else {
                                                                                                                                                $selected = "";
                                                                                                                                        }
                                                                                                                                    ?>
                                                                                                                                <option value="<?php echo $value['dep_name'];?>" <?php echo $selected; ?>><?php echo $value['dep_name'];?></option>
                                                                                                                                <?php }?>
                                                                                                                            </select>
															</div>
														</div>
													...
													<!--/span-->
														...
														<div class="form-group">
															...
															<div class="col-md-5">
                                                                                                                            <input type="text" name="subject" id="subject" class="form-control" value="<?php echo $details['news_subject']; ?>">
															</div>
														</div>
													</div>
													<!--/span-->
														...
														<div class="form-group">
															...
															<div class="col-md-10">
                                                                                                                            <textarea class="ckeditor form-control" rows='5' id="news" name="news" placeholder="Your Description"><?php echo $details['news_body']; ?></textarea>
															</div>
														</div>
													</div>
													<!--/span-->

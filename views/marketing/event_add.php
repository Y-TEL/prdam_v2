...
if (isset($_POST['add'])) {
    ...
    $entered_by    = $_SESSION['first_name'];
    ...
    $msg = $event->addEvent($event_name,$event_date,$event_time_us,$SLTime,$entered_by,$created_date,$created_time);
    
    if ($msg=1) { 
        header('Location: events_view?id='.$msg);
    }
}
						  ...
						  <div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Event
										</div>
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
                                                                                ...
                                                                                <form id="commentForm" class="form-horizontal" name ="add_event" action="" method="post" enctype="multipart/form-data"> 
											<div class="form-body" >
														...
														<div class="form-group">
															...
															<div class="col-md-5">
                                                                                                                            <textarea class="form-control" rows='5' id="event_name" name="event_name" placeholder="Your Event"></textarea>
															</div>
														</div>
													</div>
													<!--/span-->
														...
														<div class="form-group">
                                                                                                                    ...
                                                                                                                    <div class="col-md-5">
                                                                                                                        ...
                                                                                                                        <input type="text" class="form-control" id="datepicker" readonly name="event_date" value="<?php if (isset($_POST['event_date'])) {echo $_POST['event_date']; }else{echo date('m-d-Y');} ?>">
                                                                                                                ...
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-md-5">
                                                                                                                            <div class="input-append bootstrap-timepicker">
                                                                                                                                <input id="timepicker1" type="text" class="input-small" name="event_time_us" value="<?php if (isset($_POST['event_time_us'])) {echo $_POST['event_time_us']; }else{echo date('h:i A');} ?>">

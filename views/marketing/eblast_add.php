...
if (isset($_POST['add'])) {
    ...
    $USTime = date('h:i A', $eblast_time_us);
        ...
        $msg = $eblast->addNewEblast($cam_title,$eblast_product,$eblast_respond,$eblast_dealer,$eblast_agent,$eblast_date,$eblast_time_sl,$USTime,$dealer_satisfaction,$created_date);
        
  if ($msg=1) {
      header('Location: eblast_feedbacks_view?id='.$msg);
    }
  }
?>
<!DOCTYPE html>
						  ...
						  <div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add New Eblast Feedback
										</div>
                                                                                                                        ...
                                                                                                                        <div class="col-md-4">
                                                                                                                                <select name="camp_title" id="camp_title" class="form-control" >
                                                                                                                                    ...
                                                                                                                                    <?php  foreach ($drop_down_camp_title as $values) {
                                                                                                                                        ...
                                                                                                                                        ?>
                                                                                                                                    <option value="<?php echo $values['camp_id'];?>" <?php echo $selected; ?>><?php echo $values['camp_title']." (".$values['camp_date']." ".$values['camp_time_sl'].")";?></option>
                                                                                                                                    <?php }?>
                                                                                                                                </select> 
                                                                                                                        </div>
                                                                                                                </div>
												...
												<!--/row-->
													...
													<div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-md-4">
                                                                                                                                <input type="text" name="eblast_product" id="eblast_product" class="form-control">
                                                                                                                        </div>
                                                                                                                </div>
                                                                                                        </div>
                                                                                                        <!--/span-->
												...
												<!--/row-->
													...
													<div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-md-4">
                                                                                                                                <input type="text" name="eblast_respond" id="eblast_respond" class="form-control">
                                                                                                                        </div>
                                                                                                                </div>
                                                                                                        </div>
                                                                                                        <!--/span-->
												...
												<!--/row-->
													...
													<div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-md-4">
                                                                                                                                <input type="text" name="eblast_dealer" id="eblast_dealer" class="form-control">
                                                                                                                        </div>
                                                                                                                </div>
                                                                                                        </div>
                                                                                                        <!--/span-->
												...
												<!--/row-->
														...
														<div class="form-group">
                                                                                                                    ...
                                                                                                                    <div class="col-md-4">
                                                                                                                        ...
                                                                                                                        <input type="text" class="form-control" id="datepicker" readonly name="eblast_date" value="<?php if (isset($_POST['eblast_date'])) {echo $_POST['eblast_date']; }else{echo date('m/d/Y');} ?>">
                                                                                                                ...
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="col-md-4">
                                                                                                                            <div class="input-append bootstrap-timepicker">
                                                                                                                                <input id="timepicker1" type="text" class="input-small" name="eblast_time" value="<?php if (isset($_POST['eblast_time'])) {echo $_POST['eblast_time']; }else{echo date('h:i A');} ?>">
                                                                                                                                ...
                                                                                                                                <div class="form-md-radios">
                                                                                                                                    <div class="md-radio-inline">
                                                                                                                                            <div class="md-radio col-md-12">
                                                                                                                                                <input type="radio" id="radio1" name="dealer_satisfaction" class="md-radiobtn" value="Turnaround" checked>
                                                                                                                                                    <label for="radio1">
                                                                                                                                                    <span></span>
                                                                                                                                            ...
                                                                                                                                            <div class="md-radio col-md-12">
                                                                                                                                                    <input type="radio" id="radio2" name="dealer_satisfaction" class="md-radiobtn" value="Excited">
                                                                                                                                                    <label for="radio2">
                                                                                                                                                    <span></span>
                                                                                                                                                    <span class="check"></span>
                                                                                                                                                    <span class="box"></span>
                                                                                                                                            ...
                                                                                                                                            <div class="md-radio col-md-12">
                                                                                                                                                    <input type="radio" id="radio3" name="dealer_satisfaction" class="md-radiobtn" value="Interested">
                                                                                                                                                    <label for="radio3">
                                                                                                                                                    <span></span>
                                                                                                                                                    <span class="check"></span>
                                                                                                                                                    <span class="box"></span>
                                                                                                                                            ...
                                                                                                                                            <div class="md-radio col-md-12">
                                                                                                                                                    <input type="radio" id="radio4" name="dealer_satisfaction" class="md-radiobtn" value="Unsatisfied">
                                                                                                                                                    <label for="radio4">
                                                                                                                                                    <span></span>
                                                                                                                                                    <span class="check"></span>
                                                                                                                                                    <span class="box"></span>
                                                                                                                                            ...
                                                                                                                                            <div class="md-radio col-md-12">
                                                                                                                                                    <input type="radio" id="radio5" name="dealer_satisfaction" class="md-radiobtn" value="Unsubscribe">
                                                                                                                                                    <label for="radio5">
                                                                                                                                                    <span></span>
                                                                                                                                                    <span class="check"></span>
                                                                                                                                                    <span class="box"></span>
